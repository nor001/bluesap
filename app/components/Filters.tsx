  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border">
      ...
      <div className="space-y-4">
        {/* Project Filter */}
        <div>
          <label htmlFor="proy-filter" className="block text-sm font-medium text-gray-700 mb-2">
            Project (PROY):
          </label>
          <select
            id="proy-filter"
        ...
        {/* Module Filter */}
        <div>
          <label htmlFor="modulo-filter" className="block text-sm font-medium text-gray-700 mb-2">
            Module:
          </label>
          <select
            id="modulo-filter"
        ...
        {filterOptions.grupoOptions.length > 1 && (
          <div>
            <label htmlFor="grupo-filter" className="block text-sm font-medium text-gray-700 mb-2">
              Development Group:
            </label>
            <select
              id="grupo-filter"
